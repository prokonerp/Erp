...
/** Battery bank qty: optional, integer, hard cap 40 (matches the QTY-driven grid). */
const optionalBatteryQty = z.preprocess(
  emptyToUndefined,
  z.coerce.number().int().positive().max(40, "Battery qty cannot exceed 40").optional(),
);
...
export const MAX_BATTERY_READINGS = 40;
