...
export const NAV_ITEMS: NavItem[] = [
  ...
  { to: "/sales/proforma/settings", label: "PI Settings", icon: Settings2, module: "sales", group: "Sales", adminOnly: true },
  ...
  { to: "/ims/stock-management-beta", label: "Stock Management (BETA)", icon: Layers, module: "ims", group: "Inventory" },
  {
