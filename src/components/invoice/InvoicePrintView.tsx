...
export type InvoicePrintProps = {
  ...
  /** User's authorised signature image (from app_users.signature_url) — falls back to company.seal_url */
  authorisedSignatureUrl?: string | null;
  /** Watermark flags — diagonal faint text */
  isReprint?: boolean;
...
export function InvoicePrintView({
  ...
  void showIrnBand; // retained for parity — IRN band now always renders skeleton (dash when blank)
