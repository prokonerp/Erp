...
const ImsDashboardCharts = lazy(() => import("@/components/ImsDashboardCharts"));
...
function Dashboard() {
  ...
  // Chart data for the lazy-loaded charts section
  ...
  return (
    <div className="space-y-6">
      ...
      <Suspense fallback={<div className="h-64 animate-pulse bg-muted rounded-lg" />}>
        <ImsDashboardCharts pieData={pieData} grnData={grnData} days={days} oemData={oemData} />
      </Suspense>
